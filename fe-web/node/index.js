 ...
 * 拆解egg-beehive项目
 * @description:数据库设计
 * 1. 在开始具体的curd业务之前，先要分析业务，建立数据库模型
 *   1.1 一般都是ORM结合数据库实现数据的读写，工具，框架层面可以具体看
 *   1.2 框架层面一般实现MVC或者其它形式的分层
 * 2. 业务场景分析，表结构设计到具体接口设计
 *    2.1 user表
 *      2.1.0 user表创建首先基于mysql语句
