 ...
 *  0.2 定义指标，量化数据结果产出
 *  0.3 这一部分的理解不一定全，可以借鉴架构设计的方法，有全局意识
 * 1.业务层
 ...
 *   1.1 业务模型基于组件设计，组件结构和代码设计模式是工程师的基础，这个和框架无关，属于需要沉淀的能力
 * 2. 流程优化能力
 ...
 *   5.1 要去做有护城河，有持续性积累的事情，如果应用层总在变我们要观察其中不变的东西，这样即使敏感性降低也能很快熟练起来（掌握的工具多不是核心能力）
 *   5.2 关注核心能力的积累并做到有效训练（看起来之前就有关注这一点），注意不要焦虑于形的变化，面向JD的适配只需要微调即可
 *   5.3 问自己几个问题，是不是在做有效积累
 *
 *
 */
 ...
 * web领域的核心能力如下
 * 参考项目如下
 * https://github.com/streamich/react-use (react hooks 组件实现)
 *
 * 1. 看起来范畴很广，多数无法形成有效积累
 *   1.1 组件实现
 *    1.1.1 业务组件沉淀
 *    1.1.2 组件库发布
 *   1.2 逻辑复用
 *    1.2.1 工具库沉淀
 *    1.2.2 hooks/composition api 沉淀
 *    1.2.3 工具库发布
 *
 *
 */
